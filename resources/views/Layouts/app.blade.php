            ...
            <div class="container">
                <nav>
                    <ul>
                        ...
                        <li><a href="/struktur-organisasi"><i class="fas fa-users"></i> Struktur Organisasi</a></li>
                        <li><a href="/layanan"><i class="fas fa-stethoscope"></i> Layanan Umum</a></li>
                        <li><a href="/visi-misi"><i class="fas fa-bullseye"></i> Visi Misi dan Tujuan</a></li>
