<aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
    <div class="sidebar-brand text-center py-3">
        <a href="/" class="brand-link d-flex align-items-center justify-content-center">
            <img src="{{ asset('assets/img/lararshp-logo.png') }}" class="brand-image shadow" alt="LARARSHP Logo" style="height:40px;width:auto;">
            <span class="brand-text fw-bold ms-2" style="font-size:1.2rem;">LARARSHP</span>
        </a>
    </div>
