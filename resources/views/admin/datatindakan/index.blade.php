...
<div class="page-section">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
        <h2 style="color: #319da7;"><i class="fas fa-procedures"></i> Manajemen Kode Tindakan & Terapi</h2>
            <a href="{{ route('kode-tindakan-terapi.create') }}" class="btn btn-success action-create" style="border-radius: 8px; font-weight: 600; background: #2ecc71;">
        ...
        <table class="table-standard" style="font-size: 1.15rem;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('kode-tindakan-terapi.edit', $item->idkode_tindakan_terapi) }}" class="action-edit">Edit</a>
                        <a href="{{ route('kode-tindakan-terapi.delete', $item->idkode_tindakan_terapi) }}" class="action-delete">Hapus</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
